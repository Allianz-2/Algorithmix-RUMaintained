        ...
        <div class="right-panel">
            ...
            <form action="7-StudentRegistration.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="userID" name="userID" pattern="^G[0-9]{2}[A-Za-z][0-9]{4}$" placeholder="G00X0000" required>
                </div>
                <div class="form-group">
                    <label for="email">Email Address</label>
                    <input type="email" id="email" name="email" pattern=".+@campus.ru.ac.za" placeholder="G00X0000@campus.ru.ac.za" required>
                </div>
