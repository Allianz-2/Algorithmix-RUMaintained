...
<head>
    ...
    <style>
        body, html {
            ...
            background-image: url('Images\General\background.jpeg');
        ...
        .container {
            ...
            height: auto;
            padding: 20px;
           background-image: url('/Users/naledimabusela/Documents/GitHub/Algorithmix-RUMaintained/Images/General/purple gradient background.jpeg');
            color: white;
            margin-top: 0;
            display: flex;
            justify-content: center;
