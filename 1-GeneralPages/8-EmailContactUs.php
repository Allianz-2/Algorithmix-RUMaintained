...
if (isset($_POST['submit'])) {
    ...
    $mailAlgor= "spies.daniel20@gmail.com";



    // Create a Transport object
    $transport = Transport::fromDsn('smtp://spies.daniel20@gmail.com:ixyzzodorxwgvxcg@smtp.gmail.com:587');
    ...
    $email->from($mailAlgor);

    // Set the "To address"
    $email  ->addTo($mailAlgor)
            ->addTo('tzaliber@gmail.com')
            ->addTo('spies.daniel19@gmail.com');
    ...
    // Set a "subject"
    $email->subject('Get in touch: ' . $name . ' - ' . $emailFrom);
